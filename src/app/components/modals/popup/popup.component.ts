...
export class PopupComponent implements OnInit, DoCheck {
    ...
    @Input() public fotter_2_ActionName?: string;
    @Input() public fotter_2_CancelName?: string;
    @Input() public isHeaderCloseBtn?: boolean = true;
    ...
    private initConf(): void {
        ...
        this.conf = {
            ...
            isHeaderCloseBtn: this.isHeaderCloseBtn || true,
